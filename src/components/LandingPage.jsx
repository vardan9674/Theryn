...
function ConversionLandingContent({ onEnterApp }) {
  ...
  return (
    <div className="theryn-conversion-landing" style={{ fontFamily: "-apple-system, 'Helvetica Neue', Helvetica, sans-serif", background: c.bg, color: c.tx, minHeight: "100vh", overflow: "hidden" }}>
      <style>{`html{scroll-behavior:smooth}.theryn-conversion-landing section{scroll-margin-top:80px}.theryn-conversion-landing h1,.theryn-conversion-landing h2,.theryn-conversion-landing h3{font-weight:800}.theryn-conversion-landing button{font-family:inherit;cursor:pointer;transition:transform .2s ease,box-shadow .2s ease}.theryn-conversion-landing button:hover{transform:translateY(-2px)}@media(min-width:701px){.theryn-conversion-landing .hero-actions{flex-direction:column;max-width:540px}.theryn-conversion-landing .hero-actions button{width:100%;display:flex;justify-content:space-between;align-items:center;text-align:left}}@media(max-width:700px){.theryn-conversion-landing header nav{display:none}.theryn-conversion-landing #home,.theryn-conversion-landing #athletes{grid-template-columns:1fr!important;gap:42px!important;min-height:auto!important}.theryn-conversion-landing #home{padding-top:70px!important}.theryn-conversion-landing .hero-actions{flex-direction:row}.theryn-conversion-landing .hero-actions button{flex:1;min-width:0;padding-left:13px!important;padding-right:13px!important;font-size:12px}.theryn-conversion-landing #coaches{padding-top:80px!important}.theryn-conversion-landing #coaches>div:first-child{display:block!important}.theryn-conversion-landing #coaches>div:first-child>p{margin-top:24px}.theryn-conversion-landing .closing-grid{grid-template-columns:1fr!important}.theryn-conversion-landing .closing-grid>div:last-child{border-left:0!important;border-top:1px solid ${c.bd};padding:48px 0 0!important}.theryn-conversion-landing h1{font-size:clamp(48px,14vw,68px)!important}.theryn-conversion-landing h2{font-size:clamp(38px,11vw,54px)!important}.theryn-conversion-landing #home>div:last-child{transform:scale(.92);transform-origin:top center;margin-bottom:-18px}}@media(prefers-reduced-motion:reduce){.theryn-conversion-landing *{animation:none!important;transition:none!important;scroll-behavior:auto!important}}`}</style>
