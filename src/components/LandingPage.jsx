...
function ConversionLandingContent({ onEnterApp }) {
  ...
  useEffect(() => {
    if (!motionOn) return;
    const athleteTimer = setInterval(() => setStep(s => (s + 1) % 3), 2200);
