...
| 1.10 | Shareable client links per decision 0006: public `/f/<token>` page for workout check-ins and measurements, Share link sheet, link data on the client page | done | Merged PR #40 on 2026-09-12; migration `20260912120000_client_links.sql` applied the same day and verified live |
