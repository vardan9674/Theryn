...
| 1.10 | Shareable client links per decision 0006: public `/f/<token>` page for workout check-ins and measurements, Share link sheet, link data on the client page | doing | Branch `feat/client-links`; migration `20260912120000_client_links.sql` via SQL editor |
